...
class FitbizRevenueTotalCommonCardHeader extends CommonCard {
  FitbizRevenueTotalCommonCardHeader({
    Key? key,
    ...
    bool? isShowArrow,
          ...
          key: key,
          cardTitle: cardTitle,
          cartTitleIcon: SvgPicture.asset("assets/images/payment_icon.svg"),
          cardPrimaryColor: Color(0xffBF59F1),
          ...
          cartTitleTextStyle:
              AppThemeData.summaryPageThemeData().textTheme.headline4!.copyWith(fontFamily: "Bariol", color: Color(0xffBF59F1)),
        );
}
